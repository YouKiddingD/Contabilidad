...
var table = $('#TableEstadosdeCuenta').DataTable({
    ...
    },
    {
      ...
      "mRender": function (data, type, full) {
       ...
       return '<a href="'+evXML+'" target="_blank" class="btn btn-primary btn-elevate btn-pill btn-sm" id="BtnVerXML"><i class="flaticon2-file"></i></a>';
     }
   },
    {
      "width": "3%",
      ...
      "targets": 12,
      "mRender": function (data, type, full) {
       return ( full[10] === 'Pendiente' ? '<button type ="button" class="btn btn-danger btn-elevate btn-pill btn-sm" id="BtnEliminarFactura" data-idfact="'+idfac+'"><i class="flaticon-delete"></i></button>':'');
     }
     }
   ]
    });
